...
def secondwindow():
    ...
    l6 = Label(sroot, text="then press on convert button to convert the value", font=('arial 10', 11, 'italic bold'),
               bg="skyblue")
    l6.place(x=30, y=200)
...
button = Button(root, width=10, text="convert", font=('arial 10 ', 10, 'bold'), command=lambda: todecimal()).place(
    x=183, y=200)

button = Button(root, width=10, text="how to use", font=('arial 10 ', 10, 'bold'),
                command=lambda: secondwindow()).place(x=90, y=200)
